...
The current app is a safe preview and launch-draft preparation surface. It never broadcasts a transaction. Before production deployment, configure a non-zero `HOODIEPAD_ECOSYSTEM_SAFE`, calibrate the V3 curve on a current Robinhood mainnet fork, verify canonical dependency bytecode, and complete an external review. See `PRODUCT_DECISIONS.md`.
